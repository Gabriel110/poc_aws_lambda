...
aws --endpoint-url=http://localhost:4566 dynamodb put-item --table-name my_table --item '{\"id\":{\"S\":\"1\"},\"internal_process_status_code\": {\"N\": \"0\"},\"client_id\":{\"S\":\"sss123\"},\"chargeback_id\":{\"S\":\"54566567\"},\"internal_actual_defense_document_status_code\":{\"N\":\"13\"}}'
